/*
 * TypingMind Excel Data Engine - Extension v0.4.1 TEST
 *
 * DIAGNOSTIC VERSION
 *
 * Purpose:
 * - Confirm DuckDB-Wasm loads correctly.
...
(() => {
  ...
  const APP_ID = "tm-excel-engine-v041-test";

  /*
   * Same DuckDB-Wasm package used by the working v0.4 test.
   */
  ...
  function addStyles() {
    if (document.getElementById("tmxe-v041-style")) return;

    const style = document.createElement("style");

    style.id = "tmxe-v041-style";
    ...
    style.textContent = `
      ...
      #tmxe-v041-status[data-kind="ok"] {
        color: #16a34a;
      }

      #tmxe-v041-status[data-kind="error"] {
        color: #dc2626;
      }
  ...
  function createButton() {
    if (document.getElementById("tmxe-v041-button")) return;

    const button = document.createElement("button");

    button.id = "tmxe-v041-button";

    button.type = "button";

    button.textContent = "🧪 Excel v0.4.1";

    button.title =
      "Diagnóstico de extensión Excel";
  ...
  function openPanel() {
      ...
      >
        ...
        ">
          ...
          <div>
            ...
            <div id="tmxe-v041-help">
              Diagnóstico de DuckDB-Wasm y
              extensión Excel.
            </div>
        ...
        <div id="tmxe-v041-status">
          Listo para iniciar diagnóstico.
        </div>

        <div id="tmxe-v041-actions">
    ...
    document
      .getElementById("tmxe-v041-close")
      .addEventListener(
        "click",
        () => overlay.remove()
      );
