/*
 * TypingMind Excel Data Engine - Extension v0.1
...
(() => {
  ...
  const CDN_MODULE = `https://cdn.jsdelivr.net/npm/@duckdb/duckdb-wasm@${DB_VERSION}/+esm`;
    ...
    overlay.innerHTML = `
      <div id="tmxe-panel" role="dialog" aria-modal="true">
        ...
        <div style="margin-top:10px;opacity:.7">
          v0.1 — DuckDB-Wasm local. No servidor propio.
        </div>
      </div>
    `;
